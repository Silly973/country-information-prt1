...
Stappen:
1. Create async function om de country data op te halen
2. Create function to add li elementen met content
3. Create function to get region
4. Map alle countries en add alle elementen
*/ async function getCountries() {
    try {
        const result = await _axiosDefault.default.get('https://restcountries.com/v2/all?fields=name,region,subregion,flags,population');
...
function readablePopulation(_population) {
    if (_population === 0) return "undefined";
...
function getRegionClass(_country) {
    switch(_country.region){
        ...
        case 'Africa':
        case 'Oceania':
            return _country.region.toLowerCase();
        case 'Americas':
